...
# Development DB (comment out for production)
DATABASES = {
    'default': {
...
# Production DB (uncomment and set your real credentials)
DATABASES = {
    'default': {
...
# Session settings for proper logout behavior
...
CSRF_COOKIE_DOMAIN = '.buckeyeit.com'
SESSION_COOKIE_DOMAIN = '.buckeyeit.com'
